...
module.exports = (sequelize, DataTypes) => {
  class User extends Model {
    ...
    static associate(models) {
      ...
      User.belongsToMany(models.Conversation, { through: "Participant" }); //join salen muy fácil
      User.hasMany(models.Participant, {foreignKey: 'UserId'}); //hacer los join es muy complejo
    }
  }
  User.init(
    {
